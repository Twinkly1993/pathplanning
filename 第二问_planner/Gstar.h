...
class GstarPlannerROS : public nav_core::BaseGlobalPlanner {
public:
  GstarPlannerROS (ros::NodeHandle &); 
  GstarPlannerROS ();
  GstarPlannerROS(std::string name, costmap_2d::Costmap2DROS* costmap_ros);
  ros::NodeHandle ROSNodeHandle;
  void initialize(std::string name, costmap_2d::Costmap2DROS* costmap_ros);
  bool DoPlan(const geometry_msgs::PoseStamped& start, 
  ...
  vector<int> GstarPlanner(int startCell, int goalCell);
